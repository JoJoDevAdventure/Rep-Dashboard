...
import { Calls, liveCall } from "@/data"; // Mock call data
...
const MainContent = ({ calls }) => {
  ...
  const [currentCall, setCurrentCall] = useState(Calls[0]); // State to track the currently active cal
  ...
  return (
    ...
    >
      ...
      <Tabs
        ...
        tabs={["Calls History", "Call Preview", " ⭕️ LIVE Call Demo"]}
      />
